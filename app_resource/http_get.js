...
exports.httpGet = (app) => {
    ...
    app.get("/lorem_ipsum", (req, res) => {
        ...
        fs_1.createReadStream(`${__dirname}/resource_files/lorem_ipsum.txt`)
            .pipe(res)
            .on("finish", () => console.log('sent out tons of lorem ipsums'));
    });
    ...
    app.get("/profile/:name", (req, res) => {
        ...
        res.render("profile", { person: req.params.name, data: data }, (err, html) => {
